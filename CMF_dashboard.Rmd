...
#remove NAs from counties that do not have any graduates and add new text
county_grads$newtext <- ifelse(is.na(county_grads$mytext), paste0("County: ", county_grads$County, 
                                                                  "<br>", "No praticing graduates in this County"), county_grads$mytext)
...
grads_discipline$newtext <- ifelse(is.na(grads_discipline$my_text), paste0("County: ", grads_discipline$County, 
                                                                  "<br>", "No praticing graduates in this County"), grads_discipline$my_text)
...
group_by(County, Population) %>% 
  ...
  mutate(mytext = paste0("County: ", County, "<br>",
                         "Number of FM Physicians: ", n, "<br>",
                         "County Population: ", prettyNum(Population, big.mark = ","), "<br>",
...
group_by(County, Population) %>% 
  ...
  mutate(ratio = (n / Population) * 100000) %>% 
  mutate(mytext = paste0("County: ", County, "<br>",
                         "Number of Pediatric Physicians: ", n, "<br>", 
                         "County Population: ", prettyNum(Population, big.mark = ","), "<br>",
...
group_by(County, Population) %>% 
  ...
  mutate(ratio = (n / Population) * 100000) %>% 
  mutate(mytext = paste0("County: ", County, "<br>",
                         "Number of OBGYN Physicians: ", n, "<br>",
                         "County Population: ", prettyNum(Population, big.mark = ","), "<br>",
                         "Ratio per 100,000 population: ", round(ratio, 2), sep = "")) %>% 
  mutate(text1 = paste0("County: ", County, "<br>",
                        "Ratio: ", round(ratio, 2), sep = ""))
...
fm_county <- fm_data %>% 
  ...
  mutate(text2 = paste0("County: ", County, "<br>",
                        "# of Residents: ", n, sep = ""))
...
### CalMedForce Impact Map Summary (Cohort 1 through Cohort 4)
...
cali_joined$text3 <- str_trim(cali_joined$text3, "right")
...
leaflet(cali_joined) %>% 
  addPolygons(fillColor = test_tiers(cali_joined$Tier.level),
              popup = htmlTable(cali_joined$text3, rnames = FALSE),
...
<p style="background-color:#10C637;"> Green = Tier 1 County with Awardees (High Need)</p>
<p style="background-color:#042B46;color:white;"> Blue = Tier 2 County with Awardees (Medium Need)</p>
<p style="background-color:#FF982C;"> Orange = Tier 3 County with Awardees (Lowest Need)</p>

Note: Tiers developed with data from the [California Health Care Foundation](https://www.chcf.org/publication/california-maps-primary-care-specialist-physicians-county/).
...
Sidebar {.sidebar}
-------------------------------------
<p style='font-family:montserrat'>Graduate Information</p>
...
p("The first map illustrates overall total graduates practicing in each county. The second map illustrates where the graduates are practicing by discipline. On the drop down menu below, select on a discipline to view in which counties those graduates are practing in.")
...
valueBox(total_fm,
         caption = "<p style='font-family:montserrat'># of Family Medicine Graduates</p>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
"<p style='font-size: 18px; font-family: montserrat'>%s</p><br/>",
 county_grads$newtext) %>% 
 lapply(htmltools::HTML)  
...
leaflet(county_grads) %>% 
  addPolygons(fillColor = pal(county_grads$n),
              ...
              highlightOptions = highlightOptions(weight = 5,
                                           ...
                                           fillOpacity = 0,7,
                                           bringToFront = TRUE)) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Total Number of Grads</p>", pal = pal, values = ~county_grads$n, opacity = 0.7,
...
leaflet(discipline) %>% 
  addPolygons(fillColor = pal(discipline$n),
              ...
              highlightOptions = highlightOptions(weight = 5,
                                           ...
                                           fillOpacity = 0,7,
                                           bringToFront = TRUE)) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Grads by Discipline</p>", pal = pal, values = ~discipline$n, opacity = 0.7, position = "topright")
})
...
leaflet(fm_joined, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(fm_joined$n),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Family Medicine Residents <br> Funded by CalMedForce Grant</p>", pal = qpal, values = ~fm_joined$n, opacity = 0.7,
  position = "topright", na.label = "")
...
leaflet(fm_phy, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(fm_phy$ratio),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Family Medicine Physicians <br> per 100,000</p>", pal = qpal, values = ~fm_phy$ratio, opacity = 0.7,
  position = "topright", na.label = "")
...
cycle_sum <- fm_data %>% 
  group_by(Cycle) %>% 
  summarize(n = n()) %>% 
  mutate(mytext = paste0("Number of Programs<br> Awarded: ", n))
...
plot_ly(data = fm_residents, x = ~Program.Type, y = ~Total.Positions,
        ...
        hovertext = paste("Cycle: ", fm_residents$Cycle, "<br>",
...
valueBox(fm_num,
         caption = "<b># of FM Medicine Programs Awarded</b>",
               icon = "fa-hospital",
               color = "#10C637")
})
...
valueBox(fm_num,
         caption = "<b># of FM Medicine Positions Funded</b>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
valueBox(fm_num,
         caption = "<b>Total Amount Awarded</b>",
               icon = "fa-money",
               color = "#10C637")
})
...
The data used for Primary Care Physician can be found here https://data.chhs.ca.gov/dataset/physician-survey. Data was filtered for Family Medicine Physicians and provided patient care of at least 20+ hours.
...
leaflet(im_joined, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(im_joined$n),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Internal Medicine Residents <br> Funded by the CalMedForce Grant</p>", pal = qpal, values = ~im_joined$n, opacity = 0.7,
  position = "topright", na.label = "")
...
leaflet(im_phy) %>% 
  addPolygons(fillColor = qpal(im_phy$ratio),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Internal Medicine <br>Physicians per 100,000</p>", pal = qpal, values = ~im_phy$ratio, opacity = 0.7,
  position = "topright", na.label = "")
...
plot_ly(data = im_residents, x = ~Program.Type, y = ~Total.Positions,
        ...
        hovertext = paste("Cycle: ", im_residents$Cycle, "<br>",
...
valueBox(im_num,
         caption = "<b># of IM Medicine Programs Awarded</b>",
               icon = "fa-hospital",
               color = "#10C637")
})
...
valueBox(im_num,
         caption = "<b># of IM Medicine Positions Funded</b>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
The data used for Primary Care Physician can be found here https://data.chhs.ca.gov/dataset/physician-survey. Data was filtered for Internal Medicine Physicians and provided patient care of at least 20+ hours.
...
leaflet(peds_joined, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(peds_joined$n),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Pediatric Residents <br> Funded by the CalMedForce Grant</p>", pal = qpal, values = ~peds_joined$n, opacity = 0.7,
  position = "topright", na.label = "")
...
leaflet(peds_phy) %>% 
  addPolygons(fillColor = qpal(peds_phy$ratio),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Pediatric Physicians <br>per 100,000</p>", pal = qpal, values = ~peds_phy$ratio, opacity = 0.7,
  position = "topright", na.label = "")
...
plot_ly(data = ped_residents, x = ~Program.Type, y = ~Total.Positions,
        ...
        hovertext = paste("Cycle: ", ped_residents$Cycle, "<br>",
...
valueBox(Peds_num,
         caption = "<b># of Ped Programs Awarded</b>",
               icon = "fa-hospital",
               color = "#10C637")
})
...
valueBox(Peds_num,
         caption = "<b># of Ped Positions Funded</b>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
The data used for Primary Care Physician can be found here https://data.chhs.ca.gov/dataset/physician-survey. Data was filtered for Pediatricians and provided patient care of at least 20+ hours.
...
leaflet(ob_joined, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(ob_joined$n),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>OBGYN Residents <br> Funded by the CalMedForce Grant</p>", pal = qpal, values = ~ob_joined$n, opacity = 0.7,
  position = "topright", na.label = "")
...
leaflet(ob_phy) %>% 
  addPolygons(fillColor = qpal(ob_phy$ratio),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>OBGYN Physicians <br>per 100,000</p>", pal = qpal, values = ~ob_phy$ratio, opacity = 0.7,
  position = "topright", na.label = "")
...
plot_ly(data = ob_residents, x = ~Program.Type, y = ~Total.Positions,
        ...
        hovertext = paste("Cycle: ", ob_residents$Cycle, "<br>",
...
valueBox(ob_num,
         caption = "<b># of OBGYN Programs Awarded</b>",
               icon = "fa-hospital",
               color = "#10C637")
})
...
valueBox(ob_num,
         caption = "<b># of OBGYN Positions Funded</b>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
The data used for Primary Care Physician can be found here https://data.chhs.ca.gov/dataset/physician-survey. Data was filtered for OBGYN Physicians and provided patient care of at least 20+ hours.
...
leaflet(em_joined, options = leafletOptions(zoomControl = FALSE)) %>% 
  addPolygons(fillColor = qpal(em_joined$n),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Emergency Medicine Residents <br> Funded by the CalMedForce Grant</p>", pal = qpal, values = ~em_joined$n, opacity = 0.7,
  position = "topright", na.label = "")
...
leaflet(em_phy) %>% 
  addPolygons(fillColor = qpal(em_phy$ratio),
              ...
              opacity = 1.0,
              fillOpacity = 1) %>% 
              addLegend(title = "<p style='font-family:montserrat'>Emergency Medicine <br>Physicians per 100,000</p>", pal = qpal, values = ~em_phy$ratio, opacity = 0.7,
  position = "topright", na.label = "")
...
plot_ly(data = em_residents, x = ~Program.Type, y = ~Total.Positions,
        ...
        hovertext = paste("Cycle: ", em_residents$Cycle, "<br>",
...
valueBox(em_num,
         caption = "<b># of EM Programs Awarded</b>",
               icon = "fa-hospital",
               color = "#10C637")
})
...
valueBox(em_num,
         caption = "<b># of EM Positions Funded</b>",
               icon = "fa-user-md",
               color = "#10C637")
})
...
The data used for Primary Care Physician can be found here https://data.chhs.ca.gov/dataset/physician-survey. Data was filtered for Emergency Medicine Physicians and provided patient care of at least 20+ hours.
